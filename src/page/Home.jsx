...
// Reset form values when formSubmitted state changes
   useEffect(() => {
    if (formSubmitted) {
        resetForm(); 
  ...
  return (
    <div className="container mx-auto">
      <div className="p-6 rounded-md ">
        ...
        {/* User Form */}
        <form className="mt-8 grid grid-cols-6 gap-3 bg-[#2f2f2f] p-6 rounded-md" onSubmit={handleSubmit}>
        ...
        <button
            type="submit"
            className="mt-4 w-full bg-green-500 text-white rounded-md h-10 hover:opacity-80"
        >
            Add User
        </button>
        </div>
